...
impl CanFreezePermissionless {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = CanFreezePermissionlessInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl Default for CanFreezePermissionlessInstructionData {
    fn default() -> Self {
        Self::new()
    }
}

/// Instruction builder for `CanFreezePermissionless`.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
pub struct CanFreezePermissionlessBuilder {
...
impl CanFreezePermissionlessBuilder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = CanFreezePermissionless {
...
/// `can_freeze_permissionless` CPI accounts.
pub struct CanFreezePermissionlessCpiAccounts<'a, 'b> {
...
/// `can_freeze_permissionless` CPI instruction.
pub struct CanFreezePermissionlessCpi<'a, 'b> {
...
impl<'a, 'b> CanFreezePermissionlessCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: CanFreezePermissionlessCpiAccounts<'a, 'b>,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CanFreezePermissionless` via CPI.
///
/// ### Accounts:
///
///   0. `[signer]` authority
...
///   5. `[]` extra_metas
#[derive(Clone, Debug)]
pub struct CanFreezePermissionlessCpiBuilder<'a, 'b> {
    instruction: Box<CanFreezePermissionlessCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CanFreezePermissionlessCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CanFreezePermissionlessCpiBuilderInstruction {
            __program: program,
            authority: None,
            token_account: None,
            mint: None,
    ...
    #[allow(clippy::vec_init_then_push)]
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = CanFreezePermissionlessCpi {
...
#[derive(Clone, Debug)]
struct CanFreezePermissionlessCpiBuilderInstruction<'a, 'b> {
